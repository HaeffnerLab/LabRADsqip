...
class rate_from_flops_fitter():
    def calc_2pitime(self,t,p):
        ...
        tmax = t[max_index]
        return 2*tmax
    def fit_single_flop(self,key,t,ex,trap_freq,time_2pi,excitation_scaling,sideband_order=0):
        eta = calc_eta(trap_freq, 11.5) 
        nbar,nbarerr,time_2pi,excitation_scaling = sqip_fit_single_flop(key,t,ex,trap_freq,time_2pi,eta,excitation_scaling,sideband_order)
