...
tabs =[
    gridGraphConfig('current', [graphConfig('current', max_datasets = 40), 0, 0]),
    ...
    gridGraphConfig('heatingrate', [graphConfig('heatingrate'), 0, 0]),
    gridGraphConfig('calibrations', [
                      graphConfig('car1'), 0, 0,
                      graphConfig('car2'), 0, 1,
graphConfig('axial red'), 1, 0,
graphConfig('axial blue'), 1, 1]),
gridGraphConfig('micromotion', [graphConfig('micromotion'), 0, 0]),	                      
